...
## Run pytest with coverage on the project
test:
	$(call execute_in_env, python -m pytest --color=yes --cov=mvc tests $(EXCLUDES_PYTEST))
...
## Read Matlab data and export in pandas dataframe
export-data:
	$(call execute_in_env, python mvc/fileio.py)
